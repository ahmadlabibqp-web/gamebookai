        ...
        <div className="mt-8 space-y-2">
          ...
          {game.items
            ...
            .map((it) => (
              ...
              >
                <span className="badge bg-indigo-100 text-indigo-700">{it.order}</span>
            ...
            >
              ...
              <div className="flex flex-col gap-0.5">
                <button
                  onClick={() => move(i, -1)}
                  disabled={i === 0}
                  className="rounded p-1 text-slate-400 hover:bg-slate-100 hover:text-indigo-600 disabled:opacity-30"
                >
