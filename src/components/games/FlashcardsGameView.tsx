    ...
    <div className="mx-auto max-w-2xl">
      ...
      >
        ...
        >
          ...
          {/* Back */}
          <div className="card absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-teal-50 to-emerald-50 p-8 text-center [backface-visibility:hidden] [transform:rotateY(180deg)]">
      ...
      <p className="mt-4 text-center text-sm text-slate-500">
        Known: <strong className="text-teal-600">{known.size}</strong> / {game.cards.length}
      </p>
    </div>
  );
}
