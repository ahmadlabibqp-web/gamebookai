  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      <div className="card p-8 text-center">
        ...
        {wordSolved && !isDead && (
          <p className="mb-4 text-sm font-semibold text-indigo-600">Correct!</p>
        )}
                ...
                className={`flex h-9 items-center justify-center rounded-lg text-sm font-bold transition-all ${
                  isCorrect
                    ...
                    : isWrong
                      ...
                      : 'bg-slate-100 text-slate-700 hover:bg-indigo-100 hover:text-indigo-700 disabled:opacity-40'
                }`}
              >
                {letter}
              </button>
      ...
      <p className="mt-4 text-center text-sm text-slate-500">
        Solved: <strong className="text-indigo-600">{solved}</strong> / {game.words.length}
      </p>
    </div>
  );
}
