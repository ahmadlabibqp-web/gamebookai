              ...
              <div key={r} className="flex">
                {row.map((cell, c) => {
                  ...
                  return (
                    ...
                    >
                      {clue && (
                        <span className="absolute left-0 top-0 text-[8px] font-bold text-indigo-600">
                          {clue.number}
                        </span>
                      )}
                      <input
                        ...
                        className="h-full w-full bg-indigo-50/30 text-center text-sm font-bold uppercase text-slate-800 focus:bg-indigo-100 focus:outline-none"
                      />
                    </div>
                  );
                })}
            ...
            <div className="space-y-1.5">
              {acrossClues.map((clue) => (
                <div key={`${clue.number}-a`} className="flex gap-2 text-sm">
                  <span className="font-bold text-indigo-600">{clue.number}.</span>
