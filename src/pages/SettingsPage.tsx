...
export function SettingsPage() {
  ...
  return (
    <div className="p-6 md:p-10 max-w-3xl mx-auto w-full">
        <Link
          to="/dashboard"
          className="mb-6 inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 transition-colors hover:text-indigo-700"
        >
        ...
        <div className="mb-8">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br from-indigo-500 to-indigo-600 shadow-sm">
        ...
        <div className="card p-6">
          ...
          {/* Save Feedback */}
          {saveState === 'saved' && (
            <div className="mt-4 flex items-center gap-2 rounded-xl bg-indigo-50 px-4 py-3 text-sm font-medium text-indigo-700">
