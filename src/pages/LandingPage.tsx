...
const gameTypes = [
  { icon: Target, label: 'Quiz Battle', color: 'from-indigo-500 to-indigo-500' },
  ...
  { icon: Shuffle, label: 'Drag & Drop', color: 'from-cyan-500 to-indigo-500' },
...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-600">
              Upload any PDF — textbooks, holy books, novels, research papers — and BOOKGAMEAI
        ...
        <div className="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((feature, i) => {
            ...
            return (
              ...
              >
                <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 to-indigo-600 shadow-sm transition-transform group-hover:scale-110">
        ...
        <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-6">
          {audience.map((a) => {
            ...
            return (
              <div
                key={a.label}
                className="flex flex-col items-center gap-3 rounded-2xl border border-slate-200 bg-white p-6 text-center transition-all hover:border-indigo-300 hover:shadow-md"
              >
      ...
      {/* CTA */}
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-600 to-indigo-700 py-20">
        <div className="absolute inset-0 bg-grid opacity-20" />
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          <h2 className="font-display text-3xl font-bold tracking-tight text-white sm:text-4xl">
            Ready to make learning fun?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-indigo-50">
            Upload your first PDF and generate quizzes, games, flashcards, and an AI tutor in under a minute.
          </p>
          <Link
            to="/upload"
            className="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3.5 text-base font-semibold text-indigo-700 shadow-lg transition-all hover:bg-indigo-50 hover:shadow-xl active:scale-[0.98]"
          >
            <Upload className="h-5 w-5" />
            Upload a PDF
          </Link>
      ...
      <footer className="border-t border-slate-200 bg-white py-12">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-4 sm:flex-row sm:px-6 lg:px-8">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-sm font-bold text-slate-900">BOOKGAMEAI</span>
          </div>
